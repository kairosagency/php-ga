...
namespace  Kairos\GoogleAnalytics;

use  Kairos\GoogleAnalytics\Internals\Util;
use  Kairos\GoogleAnalytics\Internals\Request\PageviewRequest;
use  Kairos\GoogleAnalytics\Internals\Request\EventRequest;
use  Kairos\GoogleAnalytics\Internals\Request\TransactionRequest;
use  Kairos\GoogleAnalytics\Internals\Request\ItemRequest;
use  Kairos\GoogleAnalytics\Internals\Request\SocialInteractionRequest;
...
class Tracker {
    ...
    /**
     * @var \Kairos\GoogleAnalytics\Campaign
     */
    protected $campaign;
    ...
    /**
     * @param \Kairos\GoogleAnalytics\Config $value
     */
     ...
     * @param \Kairos\GoogleAnalytics\CustomVariable $customVariable
     */
    ...
    /**
     * @return \Kairos\GoogleAnalytics\CustomVariable[]
     */
    ...
    /**
     * @param \Kairos\GoogleAnalytics\Campaign $campaign Isn't really optional, but can be set to null
     */
    ...
    /**
     * @return \Kairos\GoogleAnalytics\Campaign|null
     */
     ...
     * @param \Kairos\GoogleAnalytics\Page $page
     * @param \Kairos\GoogleAnalytics\Session $session
     * @param \Kairos\GoogleAnalytics\Visitor $visitor
     */
     ...
     * @param \Kairos\GoogleAnalytics\Event $event
     * @param \Kairos\GoogleAnalytics\Session $session
     * @param \Kairos\GoogleAnalytics\Visitor $visitor
     */
     ...
     *
     * @param \Kairos\GoogleAnalytics\Transaction $transaction
     * @param \Kairos\GoogleAnalytics\Session $session
     * @param \Kairos\GoogleAnalytics\Visitor $visitor
     */
     ...
     * @param \Kairos\GoogleAnalytics\SocialInteraction $socialInteraction
     * @param \Kairos\GoogleAnalytics\Page $page
     * @param \Kairos\GoogleAnalytics\Session $session
     * @param \Kairos\GoogleAnalytics\Visitor $visitor
     */
