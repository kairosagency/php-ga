...
namespace  Kairos\GoogleAnalytics\Internals\Request;

use  Kairos\GoogleAnalytics\Tracker;
use  Kairos\GoogleAnalytics\Visitor;
use  Kairos\GoogleAnalytics\Session;
use  Kairos\GoogleAnalytics\CustomVariable;

use  Kairos\GoogleAnalytics\Internals\ParameterHolder;
use  Kairos\GoogleAnalytics\Internals\Util;
use  Kairos\GoogleAnalytics\Internals\X10;

abstract class Request extends HttpRequest {

    /**
     * @var \Kairos\GoogleAnalytics\Tracker
     */
    protected $tracker;

    /**
     * @var \Kairos\GoogleAnalytics\Visitor
     */
    protected $visitor;

    /**
     * @var \Kairos\GoogleAnalytics\Session
     */
    protected $session;
    ...
    /**
     * @return \Kairos\GoogleAnalytics\Internals\ParameterHolder
     */
    ...
    /**
     * @param \Kairos\GoogleAnalytics\Internals\ParameterHolder $p
     * @return \Kairos\GoogleAnalytics\Internals\ParameterHolder
     */
    ...
    /**
     * @return \Kairos\GoogleAnalytics\Tracker
     */
    ...
    /**
     * @param \Kairos\GoogleAnalytics\Tracker $tracker
     */
    ...
    /**
     * @return \Kairos\GoogleAnalytics\Visitor
     */
    ...
    /**
     * @return \Kairos\GoogleAnalytics\Session
     */
